...
2.  "cenas": Um array de objetos, onde cada objeto de cena tem "cena" (string), "falas" (string), e "detalhes" (um array de objetos).
    *   **REGRA DAS FALAS (NARRADOR E CONCISÃO MÁXIMA):** O campo "falas" é OBRIGATÓRIO para cada cena. Se nenhum personagem estiver falando, use um "NARRADOR". A CONCISÃO É CRÍTICA. Cada 'detalhe' dentro de uma cena representa um take visual de aproximadamente 5 segundos. A fala correspondente a UMA CENA INTEIRA deve ser dimensionada para a sua duração total. A regra é: **NÃO MAIS DE 15 PALAVRAS POR 'DETALHE'**. Por exemplo, se uma cena tem 3 objetos 'detalhes', o campo "falas" para essa cena inteira NÃO PODE EXCEDER 45 palavras (3 * 15). Se tiver 2 'detalhes', o limite é 30 palavras. Esta é uma restrição rígida. As falas devem ser curtas, impactantes e projetadas para serem ditas confortavelmente dentro do tempo visual da cena.
