...
2.  "cenas": Um array de objetos, onde cada objeto de cena tem "cena" (string), "falas" (string), e "detalhes" (um array de objetos).
    *   **REGRA DAS FALAS (NARRADOR E CONCISÃO):** O campo "falas" é OBRIGATÓRIO. Se nenhum personagem estiver falando, use um "NARRADOR". O texto DEVE ser conciso. Cada 'detalhe' dentro de uma cena representa um take de aproximadamente 5 segundos. Portanto, a fala para a cena inteira deve ser dimensionada de acordo (ex: 3 'detalhes' = ~15 segundos de narração, ou 30-45 palavras). As falas devem ser curtas, impactantes e conectar-se de forma coesa com a cena seguinte para manter o ritmo.
